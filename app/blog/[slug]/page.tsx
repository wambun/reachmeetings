          ...
          <div className="relative mx-auto max-w-[1600px] px-6 sm:px-8 lg:px-12">
            ...
            >
              ...
              <div className="flex flex-wrap items-center gap-4 mb-6">
                <span className="px-3 py-1 text-sm font-medium text-primary-400 bg-primary-600/10 rounded-full">
                  {post.category}
                </span>
              ...
              <div className="flex items-center gap-4 mt-8 pt-8 border-t border-white/10">
                <div className="h-12 w-12 rounded-full bg-gradient-to-br from-primary-600/20 to-secondary-600/20 flex items-center justify-center">
                ...
                <div
                  ...
                  dangerouslySetInnerHTML={{
                    __html: post.content
                      ...
                      .replace(/- (.*)/g, '<li class="text-gray-400">$1</li>')
                      .replace(/\n\n/g, '</p><p class="text-gray-400 leading-relaxed">')
                  }}
                />
              </motion.article>
                  ...
                  <div className="p-6 rounded-xl bg-white/5 border border-white/5">
                    ...
                    <div className="space-y-4">
                      {relatedPosts.map((relatedPost) => (
                        ...
                        >
                          <p className="text-sm text-white group-hover:text-primary-400 transition-colors line-clamp-2">
                            {relatedPost.title}
                          </p>
            ...
            <div className="flex justify-between items-center">
              {prevPost ? (
                <Link
                  ...
                  className="group flex items-center gap-4 text-gray-400 hover:text-white transition-colors max-w-sm"
                >
              ...
              {nextPost && (
                <Link
                  ...
                  className="group flex items-center gap-4 text-gray-400 hover:text-white transition-colors text-right max-w-sm"
                >
                  <div>
